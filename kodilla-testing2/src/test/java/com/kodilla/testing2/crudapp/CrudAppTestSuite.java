...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://makos81.github.io";
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        removeAddedTask(taskName);
    }

    private void removeAddedTask(String taskName) throws InterruptedException {
        driver.navigate().refresh();                                         // [1]
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {                                          // [7]
                    WebElement buttonCreateCard =                              // [11]
                            theForm.findElement(By.xpath(".//button[text()=\"Delete\"]")); // [12]
                    buttonCreateCard.click();                                  // [13]
                });                                                            // [14]
        Thread.sleep(5000);
    }
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("maciejrajcic@gmail.com");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("jakieshaslo");		    // [4]
